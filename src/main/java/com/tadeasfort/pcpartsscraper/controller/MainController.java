...
public class MainController {
        ...
        public String parts(
                ...
                Page<Part> partsPage = partService.findWithFilters(
                                partType, itemType, modelName, minPrice, maxPrice, marketplace, source, maxAge, search,
                                pageable);
                ...
                Map<String, PartType> priceStatistics = partsPage.getContent().stream()
                                ...
                                .map(entry -> {
                                        ...
                                        Optional<PartType> partTypeOpt = partTypeRepository
                                                        .findByModelNameAndItemType(part.getModelName(),
                                                                        part.getItemType());
                                        return partTypeOpt.map(pt -> Map.entry(key, pt)).orElse(null);
                                })
